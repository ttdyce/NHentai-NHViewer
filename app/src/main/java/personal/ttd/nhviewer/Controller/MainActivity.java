...
//    }
    ...
    private void initSearchSetting() {
        ...
        String storedLanguage = pref.getString(SettingFragment.KEY_PREF_DEFAULT_LANGUAGE, "not set");

        if(storedLanguage.equals("not set")){
            //pop up dialog for setting default language
            final EditText etDefaultLanguage = new EditText(this);
            AlertDialog.Builder builder = new AlertDialog.Builder(this);

            etDefaultLanguage.setInputType(InputType.TYPE_CLASS_TEXT);

            builder.setTitle("Would you like to set default language?");
            builder.setView(etDefaultLanguage);

            builder.setPositiveButton("Set", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    SharedPreferences.Editor editor = pref.edit();
                    editor.putString(SettingFragment.KEY_PREF_DEFAULT_LANGUAGE, etDefaultLanguage.getText().toString());
                    editor.apply();
                }
            });
